...
define('DOMAIN_URL', 'http://makein.store/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u897211733_makein";  // Change as required
    private $db_pass = "Makein@2022";  // Change as required
    private $db_name = "u897211733_makein";    // Change as required
